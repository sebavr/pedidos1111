...
<body>
	...
	<div class="container my-4">
        ...
        <h2 class="my-4">Datos de la compra:</h2>
        <div class="col-8 mx-2 p-4 border border-2" id="box">
           ...
           <table class="table table-sm table-borderless border border-dark">
                    ...
                    <c:forEach var="p" items="${productoPedidos}">
						<tr>
							...
							<td class="border border-1">${p.producto.id}</td>
							<td class="border border-1">${p.producto.nombre}</td>
							<td class="border border-1">${p.cantidad}</td>
							<td class="border border-1">${p.precio}</td>
					    </tr>
